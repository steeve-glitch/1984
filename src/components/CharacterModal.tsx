  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-3xl font-bold text-ministry-black dark:text-white mb-4 font-propaganda border-b-2 border-party-red pb-2">{character.name}</h3>
        <p className="text-gray-700 dark:text-gray-300 font-terminal leading-relaxed">{character.description}</p>
      </div>
    </div>
  );
};
